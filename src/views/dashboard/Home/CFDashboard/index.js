...
const mockCF = [
    ...
    {buyerName:"Lamduan",orderId:"7463846351",item:"wireles charger",amount:"1",price:"2000",date:date.toString(),location:"110/480 bangapi lardprow bangkok 10240"},
    {buyerName:"Pintip",orderId:"8141846351",item:"pen",amount:"20",price:"300",date:date.toString(),location:"110/480 bangapi lardprow bangkok 10240"},
    {buyerName:"Kann",orderId:"8141846352",item:"magic keyboard",amount:"1",price:"9900",date:date.toString(),location:"110/480 bangapi lardprow bangkok 10240"},
    {buyerName:"Chaka",orderId:"8141846353",item:"galaxy tab s6",amount:"1",price:"24500",date:date.toString(),location:"110/480 bangapi lardprow bangkok 10240"},
    {buyerName:"Pintip",orderId:"8141846354",item:"TV",amount:"1",price:"4000",date:date.toString(),location:"110/480 bangapi lardprow bangkok 10240"},
        ...
        <Paper elevation={6} className={classes.root}>
            <CardContent >
                <Grid container justify="flex-start" alignItems="center" >
                    ...
                    <Grid item><Typography variant="h5">{`รายการสั่งซื้อ (${mockCF.length})`}</Typography></Grid>
                </Grid>
                ...
                <Grid container justify="flex-start" spacing={3} >
                    ...
                    /></Grid>
                    <Grid item xs={2}><TextField variant="outlined" fullWidth size="small" label="sort by" select defaultValue="orderId">
                        {sortBy.map((sorter)=>(
